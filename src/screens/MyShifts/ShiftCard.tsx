...
export default function ShiftCard({
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      // Раньше здесь был ещё и alert('Смена подтверждена!') — вторая нативная
      // модалка подряд после confirm() выше. Убрали: карточка и так меняется
      // на «✓ Подтверждено» после onCancel(), достаточно одного диалога.
