...
- короткая директива официанту (что предложить), затем ГОТОВАЯ ПРЯМАЯ ЦИТАТА в кавычках — дословно, что он говорит гостю, построенная на приёме продаж:
   • «выбор без выбора» — не «будете напиток?», а «что принести — X или Y?»;
   • «социальное доказательство» — «сегодня гости особенно хвалят X»;
   • вкусовое сочетание — «к вашему X идеально подойдёт Y»;
   • срочность — «осталась последняя порция X».
Выбери ОДИН, самый уместный приём. Цитата — живая и конкретная, с названием блюда. Без воды и без перечисления всех категорий.
Верни СТРОГО JSON: {"text":"<директива + прямая цитата, 1–2 предложения>"}.`
...
export function templateSet(pools) {
  ...
  return `Предложите «${best}»: «Сегодня гости особенно хвалят «${best}» — принести к вашему заказу?».`
}
